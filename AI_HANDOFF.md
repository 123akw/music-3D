...
- GitHub 仓库已公开：`https://github.com/123akw/music-3D`
- `v1.1.0` Release：`https://github.com/123akw/music-3D/releases/tag/v1.1.0`
...
- 发布 `v1.0.4` 到 GitHub：`https://github.com/123akw/music-3D/releases/tag/v1.0.4`。
...
- 已创建并核对 GitHub Release `v0.9.12`：`https://github.com/123akw/music-3D/releases/tag/v0.9.12`，远端包含安装包、blockmap、`latest.yml` 和 `0.9.11-to-0.9.12` 快速补丁。
...
- 已推送提交 `4d9044a Prepare Mineradio 0.9.13 release` 到 `origin/main`，并创建 GitHub Release `v0.9.13`：`https://github.com/123akw/music-3D/releases/tag/v0.9.13`。远端资产包含安装包、blockmap、`latest.yml` 和 `0.9.12-to-0.9.13` 快速补丁。
