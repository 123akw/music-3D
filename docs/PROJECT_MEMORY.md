...
- GitHub 仓库：`https://github.com/123akw/music-3D.git`
...
- `v1.1.0` 已发布到 GitHub：`https://github.com/123akw/music-3D/releases/tag/v1.1.0`
- 仓库已设为公开：`https://github.com/123akw/music-3D`
- `v1.1.0` Release 资产包括：
...
- `v1.0.10` 已发布到 GitHub：`https://github.com/123akw/music-3D/releases/tag/v1.0.10`
...
- `v1.0.9` 已发布到 GitHub：`https://github.com/123akw/music-3D/releases/tag/v1.0.9`
- `v1.0.9` Release 资产包括：
  - `latest.yml`
...
- `v1.0.8` 已发布到 GitHub：`https://github.com/123akw/music-3D/releases/tag/v1.0.8`
- `v1.0.8` Release 资产包括：
  - `latest.yml`
...
- `v1.0.7` 已发布到 GitHub：`https://github.com/123akw/music-3D/releases/tag/v1.0.7`
- `v1.0.7` Release 资产包括：
  - `latest.yml`
...
- `v1.0.6` 已发布到 GitHub：`https://github.com/123akw/music-3D/releases/tag/v1.0.6`
- `v1.0.6` Release 资产包括：
  - `latest.yml`
...
- `v1.0.5` 已发布到 GitHub：`https://github.com/123akw/music-3D/releases/tag/v1.0.5`
- `v1.0.5` Release 资产包括：
  - `latest.yml`
...
- `v1.0.4` 已发布到 GitHub：`https://github.com/123akw/music-3D/releases/tag/v1.0.4`
- `v1.0.4` Release 资产包括：
  - `latest.yml`
...
- `v1.0.3` 已发布到 GitHub：`https://github.com/123akw/music-3D/releases/tag/v1.0.3`
- `v1.0.3` Release 资产包括：
  - `latest.yml`
